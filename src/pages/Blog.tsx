            ...
            {data.posts.nodes.map((post: articleTypes) => {
              return (
                <div
                  key={Math.random()}
                  className={cn(
                    "border-l-4 shadow-md hover:shadow-xl border-primary-500 rounded-xs",
                    "transition-all duration-300 bg-white p-4 w-full flex flex-col"
                  )}
                >
                  ...
                  <Link
                    className={cn(
                      "leading-6 text-2xl text-primary-700 hover:text-secondary-600",
                  ...
                  <p
                    className="text-sm text-secondary-800 mt-1.5 line-clamp-3"
