...
const FoundingAndPartners = ({ partners }: fundingAndPartnersTypes) => {
  return (
    <section className="bg-secondary-200/20 dark:bg-[#0B0C14]/25 py-8 sm:py-16 xl:py-24 w-full">
      <Container className="max-w-5xl grid grid-rows-2 grid-cols-1 md:grid-rows-1 md:grid-cols-5 gap-4">
        <div className="h-full md:col-span-3 grid grid-rows-5 gap-4">
          <h2 className="row-span-1 text-secondary-900 dark:text-amber-300 text-center font-bold uppercase">
            Apoio Financeiro
          </h2>
          <div className="h-full row-span-4 grid grid-rows-2 md:grid-rows-1 md:grid-cols-2 gap-6">
            <figure className="h-full grid place-content-start-safe content-center-safe">
              ...
              >
                <img
                  ...
                  className="w-52 max-w-full dark:hidden"
                />
                <img
                  src={
                  ...
                  className="w-52 max-w-full hidden dark:block"
                />
              </Link>
            </figure>
        ...
        <div className="h-full md:col-span-2 grid grid-rows-5 gap-4">
          ...
          <div className="row-span-4">
            <figure className="h-full grid place-content-center-safe">
              <Link
