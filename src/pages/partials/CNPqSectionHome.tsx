    ...
    <section className="bg-secondary-200/20 dark:bg-[#0B0C14]/25 py-8 sm:py-16 xl:py-24 w-full">
      <Container className="grid grid-cols-1 sm:grid-cols-2 gap-8">
        ...
        <p className={cn(
          ...
          "dark:text-white/75 font-medium text-balance sm:order-2"
        )}>
          ...
          <Link
            ...
            title="Conselho Nacional de Desenvolvimento Científico e Tecnológico (CNPq)"
            target="_blank"
            className="text-lattes-500 dark:text-amber-300/75 hover:text-secondary-500 transition-colors duration-300"
          >
